 ...
 */
class addSubscriber extends OperationBase {
    ...
    async submitTransaction() {
        const args = this.simpleState.getAddSubscriberArguments();
        await this.sutAdapter.sendRequests(this.createConnectorRequest('addSubscriber', args));
    }
}
