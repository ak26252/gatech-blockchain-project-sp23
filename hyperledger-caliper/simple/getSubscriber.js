 ...
 */
class getSubscriber extends OperationBase {
    ...
    async submitTransaction() {
        let args = this.simpleState.getGetSubscriberArguments();
        await this.sutAdapter.sendRequests(this.createConnectorRequest('getSubscribers', args));
    }
}
