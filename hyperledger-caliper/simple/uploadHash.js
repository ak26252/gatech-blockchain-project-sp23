 ...
 */
class uploadHash extends OperationBase {
    ...
    async submitTransaction() {
        let args = this.simpleState.getUploadHashArguments();
        await this.sutAdapter.sendRequests(this.createConnectorRequest('uploadHash', args));
    }
}
