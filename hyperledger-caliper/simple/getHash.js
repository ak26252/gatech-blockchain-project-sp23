 ...
 */
class getHash extends OperationBase {
    ...
    async submitTransaction() {
        let args = this.simpleState.getGetHashArguments();
        await this.sutAdapter.sendRequests(this.createConnectorRequest('getHash', args));
    }
}
