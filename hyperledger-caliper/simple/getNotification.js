 ...
 */
class getNotification extends OperationBase {
    ...
    async submitTransaction() {
        let args = this.simpleState.getGetNotificationArguments();
        await this.sutAdapter.sendRequests(this.createConnectorRequest('getNotification', args));
    }
}
