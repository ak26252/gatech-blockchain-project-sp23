...
class SimpleState {
    ...
    getRandomAccount() {
        ...
        for(let i = 0; i < 40; i++){
            ...
            address += dictionary.charAt(index);
        }
        return address;
    }
    ...
    getAddSubscriberArguments() {
        return {
            input: this.getRandomAccount(),
            sub: this.getRandomAccount()
        };
    }

    getGetSubscriberArguments(){
        return{
            account: this.getRandomAccount()
        };
    }

    getUploadHashArguments() {
        return {
            cid: "abcdefghijklmnopqrstuvwxyz1234567890",
            account: this.getRandomAccount(),
