 ...
 */
class joinNetwork extends OperationBase {
    ...
    async submitTransaction() {
        let args = this.simpleState.getJoinNetworkArguments();
        await this.sutAdapter.sendRequests(this.createConnectorRequest('joinNetwork', args));
    }
}
